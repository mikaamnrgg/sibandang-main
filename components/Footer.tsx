...
export const Footer = (props: Props) => {
  return (
    <div id='footer' className='p-4 md:rounded-tl-full bg-slate-700 text-white flex items-center md:flex-row flex-col justify-between flex-wrap'>
        ...
        <span className='font-regular font-sans text-xs text-center'>Pulau</span>
            Sibandang
        </h1>
        ...
        <div className='flex flex-1 items-center justify-end'>
            ...
            <InstagramIcon 
              className='text-white p-1 cursor-pointer hover:bg-primary/80 bg-primary rounded-full mx-1' 
              fontSize='medium' 
              onClick={() => window.open('https://www.instagram.com/kawasan_pulau_sibandang/')} 
              />
